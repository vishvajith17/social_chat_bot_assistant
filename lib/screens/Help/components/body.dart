      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            Text("ELECTRICITY"),
            Text("schedule section: "),
            Text("use Schedule keyword to get schedule"),
            SizedBox(height: size.height * 0.03),
            Text("ELECTRICITY"),
            Text("complaint section: "),
            Text("use Complaint keyword to log a complaint in electricity"),
            SizedBox(height: size.height * 0.03),
            Text("ELECTRICITY"),
            Text("sudden power-cut section: "),
            Text("use power-cut keyword to log a complaint in electricity"),
            SizedBox(height: size.height * 0.03),
            Text("TELECOMMUNICATION"),
            Text("complaint section: "),
            Text(
                "use Complaint keyword to log a complaint in telecommunication"),
            SizedBox(height: size.height * 0.03),
            Text("TELECOMMUNICATION"),
            Text("subscription section: "),
            Text("use Subscription keyword to check subscription details"),
            SizedBox(height: size.height * 0.03),
            Text("TELECOMMUNICATION"),
            Text("balance section: "),
            Text("use Balance keyword to check your balance"),
            SizedBox(height: size.height * 0.03),
          ],
        ),
      ),
